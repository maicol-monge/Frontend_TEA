...
const Home = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(apiUrl(`/api/especialistas/buscar-espe/${user.id_usuario}`), {
  ...
  const opciones = [
    {
      ...
      descripcion: "Ver usuarios en la plataforma.",
    },
    {
  ...
  return (
    ...
    >
      ...
      <div className="container py-5 flex-grow-1">
        ...
        >
          APLICACIÓN PARA LA EVALUACIÓN DE PERSONAS CON TRASTORNO DEL ESPECTRO
          AUTISTA (TEA)
        </h1>
        <h2
          className="text-center mb-5"
          style={{ color: COLOR_DARK, fontWeight: "bold" }}
        >
              ...
              >
                <div className="card-body d-flex flex-column align-items-center justify-content-center">
                  ...
                  <h5
                    ...
                    style={{ color: op.color, fontWeight: "bold" }}
                  >
                    {op.titulo}
                  </h5>
                  <p
                    className="card-text"
                    style={{ color: COLOR_DARK, fontSize: "1.05rem" }}
                  >
                    {op.descripcion}
                  </p>
                </div>
