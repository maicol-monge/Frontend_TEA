          ...
          <div className="col-12 col-md-6 col-lg-4">
            <div className="card shadow text-center" style={{ borderRadius: 18 }}>
              <div className="card-body">
                ...
                <button className="btn btn-primary" onClick={() => navigate("/admin/usuarios")}>Ir</button>
              </div>
            </div>
          </div>
          <div className="col-12 col-md-6 col-lg-4">
            <div className="card shadow text-center" style={{ borderRadius: 18 }}>
              <div className="card-body">
                ...
                <button className="btn btn-primary" onClick={() => navigate("/admin/pacientes")}>Ir</button>
              </div>
            </div>
          </div>
          <div className="col-12 col-md-6 col-lg-4">
            <div className="card shadow text-center" style={{ borderRadius: 18 }}>
              <div className="card-body">
                ...
                <button className="btn btn-primary" onClick={() => navigate("/admin/especialistas")}>Ir</button>
              </div>
            </div>
          </div>
          <div className="col-12 col-md-6 col-lg-4">
            <div className="card shadow text-center" style={{ borderRadius: 18 }}>
              <div className="card-body">
                ...
                <button className="btn btn-primary" onClick={() => navigate("/admin/areas")}>Ir</button>
              </div>
            </div>
          </div>
          <div className="col-12 col-md-6 col-lg-4">
            <div className="card shadow text-center" style={{ borderRadius: 18 }}>
              <div className="card-body">
                ...
                <button className="btn btn-primary" onClick={() => navigate("/admin/preguntas")}>Ir</button>
              </div>
            </div>
          </div>
          <div className="col-12 col-md-6 col-lg-4">
            <div className="card shadow text-center" style={{ borderRadius: 18 }}>
              <div className="card-body">
                ...
                <button className="btn btn-primary" onClick={() => navigate("/admin/actividades")}>Ir</button>
              </div>
            </div>
          </div>
          <div className="col-12 col-md-6 col-lg-4">
            <div className="card shadow text-center" style={{ borderRadius: 18 }}>
              <div className="card-body">
                ...
                <button className="btn btn-primary" onClick={() => navigate("/admin/tests-adir")}>Ir</button>
              </div>
            </div>
          </div>
          <div className="col-12 col-md-6 col-lg-4">
            <div className="card shadow text-center" style={{ borderRadius: 18 }}>
              <div className="card-body">
                ...
                <button className="btn btn-primary" onClick={() => navigate("/admin/tests-ados")}>Ir</button>
              </div>
            </div>
          </div>
        </div>
